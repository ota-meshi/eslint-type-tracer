...
/* eslint @eslint-community/eslint-comments/disable-enable-pair: 0 -- Workaround for missing types */
/* eslint-disable 
...
declare namespace Temporal {
  ...
  type ToStringRoundingOptions<Units extends DateUnit | TimeUnit> = Pick<
