import type {
  ...
  AtomicsProperty,
  TemporalProperty,
  TemporalDurationProperty,
  TemporalInstantProperty,
  TemporalPlainDateProperty,
  TemporalPlainDateTimeProperty,
  TemporalPlainMonthDayProperty,
  TemporalPlainTimeProperty,
  TemporalPlainYearMonthProperty,
  TemporalZonedDateTimeProperty,
  TemporalNowProperty,
  TemporalDurationPrototypeProperty,
  TemporalInstantPrototypeProperty,
  TemporalPlainDatePrototypeProperty,
  TemporalPlainDateTimePrototypeProperty,
  TemporalPlainMonthDayPrototypeProperty,
    ...
    properties: {
      Duration: {
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalDurationProperty, TypeInfo | undefined>,
      },
      Instant: {
        type: "Function",
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalInstantProperty, TypeInfo | undefined>,
      },
      PlainDate: {
        type: "Function",
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalPlainDateProperty, TypeInfo | undefined>,
      },
      PlainDateTime: {
        type: "Function",
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalPlainDateTimeProperty, TypeInfo | undefined>,
      },
      PlainMonthDay: {
        type: "Function",
        ...
        } satisfies Record<TemporalPlainMonthDayProperty, TypeInfo | undefined>,
      },
      PlainTime: {
        type: "Function",
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalPlainTimeProperty, TypeInfo | undefined>,
      },
      PlainYearMonth: {
        type: "Function",
      ...
      ZonedDateTime: {
        ...
        properties: {
          ...
          compare: RETURN_NUMBER,
        } satisfies Record<TemporalZonedDateTimeProperty, TypeInfo | undefined>,
      },
      Now: {
        type: "Object",
        properties: {
          ...
          timeZoneId: RETURN_STRING,
        } satisfies Record<TemporalNowProperty, TypeInfo | undefined>,
      },
...
const WELLKNOWN_PROTOTYPE: WellKnownPrototypes = {
  ...
  "Temporal.Duration": {
    ...
    sign: NUMBER,
    blank: BOOLEAN,
    with: { type: "Function", return: { type: "Temporal.Duration" } },
    negated: { type: "Function", return: { type: "Temporal.Duration" } },
    abs: { type: "Function", return: { type: "Temporal.Duration" } },
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalDurationPrototypeProperty, TypeInfo>,
  "Temporal.Instant": {
    epochMilliseconds: NUMBER,
    epochNanoseconds: NUMBER,
    add: { type: "Function", return: { type: "Temporal.Instant" } },
    subtract: { type: "Function", return: { type: "Temporal.Instant" } },
    until: { type: "Function", return: { type: "Temporal.Duration" } },
    since: { type: "Function", return: { type: "Temporal.Duration" } },
    round: { type: "Function", return: { type: "Temporal.Instant" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    valueOf: { type: "Function" },
    toZonedDateTimeISO: {
      type: "Function",
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalInstantPrototypeProperty, TypeInfo>,
  "Temporal.PlainDate": {
    calendarId: STRING,
    era: STRING,
    eraYear: NUMBER,
    ...
    add: { type: "Function", return: { type: "Temporal.PlainDate" } },
    subtract: { type: "Function", return: { type: "Temporal.PlainDate" } },
    with: { type: "Function", return: { type: "Temporal.PlainDate" } },
    withCalendar: {
      type: "Function",
      return: { type: "Temporal.PlainDate" },
    },
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalPlainDatePrototypeProperty, TypeInfo>,
  "Temporal.PlainDateTime": {
    ...
    microsecond: NUMBER,
    nanosecond: NUMBER,
    with: { type: "Function", return: { type: "Temporal.PlainDateTime" } },
    withPlainTime: {
      type: "Function",
      return: { type: "Temporal.PlainDateTime" },
    },
    ...
    add: { type: "Function", return: { type: "Temporal.PlainDateTime" } },
    subtract: { type: "Function", return: { type: "Temporal.PlainDateTime" } },
    until: { type: "Function", return: { type: "Temporal.Duration" } },
    since: { type: "Function", return: { type: "Temporal.Duration" } },
    round: { type: "Function", return: { type: "Temporal.PlainDateTime" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    valueOf: { type: "Function" },
    toZonedDateTime: {
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalPlainDateTimePrototypeProperty, TypeInfo>,
  "Temporal.PlainMonthDay": {
    calendarId: STRING,
    monthCode: STRING,
    day: NUMBER,
    with: { type: "Function", return: { type: "Temporal.PlainMonthDay" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    valueOf: { type: "Function" },
    toPlainDate: {
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalPlainMonthDayPrototypeProperty, TypeInfo>,
  "Temporal.PlainTime": {
    hour: NUMBER,
    minute: NUMBER,
    second: NUMBER,
    ...
    microsecond: NUMBER,
    nanosecond: NUMBER,
    add: { type: "Function", return: { type: "Temporal.PlainTime" } },
    subtract: { type: "Function", return: { type: "Temporal.PlainTime" } },
    with: { type: "Function", return: { type: "Temporal.PlainTime" } },
    until: { type: "Function", return: { type: "Temporal.Duration" } },
    since: { type: "Function", return: { type: "Temporal.Duration" } },
    round: { type: "Function", return: { type: "Temporal.PlainTime" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    valueOf: { type: "Function" },
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalPlainTimePrototypeProperty, TypeInfo>,
  "Temporal.PlainYearMonth": {
    ...
    monthsInYear: NUMBER,
    inLeapYear: BOOLEAN,
    with: { type: "Function", return: { type: "Temporal.PlainYearMonth" } },
    add: { type: "Function", return: { type: "Temporal.PlainYearMonth" } },
    subtract: { type: "Function", return: { type: "Temporal.PlainYearMonth" } },
    until: { type: "Function", return: { type: "Temporal.Duration" } },
    since: { type: "Function", return: { type: "Temporal.Duration" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalPlainYearMonthPrototypeProperty, TypeInfo>,
  "Temporal.ZonedDateTime": {
    ...
    inLeapYear: BOOLEAN,
    offset: STRING,
    with: { type: "Function", return: { type: "Temporal.ZonedDateTime" } },
    withPlainTime: {
      type: "Function",
      return: { type: "Temporal.ZonedDateTime" },
    },
    ...
    add: { type: "Function", return: { type: "Temporal.ZonedDateTime" } },
    subtract: { type: "Function", return: { type: "Temporal.ZonedDateTime" } },
    until: { type: "Function", return: { type: "Temporal.Duration" } },
    since: { type: "Function", return: { type: "Temporal.Duration" } },
    round: { type: "Function", return: { type: "Temporal.ZonedDateTime" } },
    equals: RETURN_BOOLEAN,
    toJSON: RETURN_STRING,
    valueOf: { type: "Function" },
    startOfDay: {
    ...
    // Symbols
    [Symbol.toStringTag]: STRING,
  } satisfies Record<TemporalZonedDateTimePrototypeProperty, TypeInfo>,
};
